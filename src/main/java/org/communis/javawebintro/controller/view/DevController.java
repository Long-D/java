...
public class DevController {
    private String USER_VIEWS_PATH = "admin/dev/";

    private final UserService userService;
    private final LdapService ldapService;

    @Autowired
    public DevController(UserService userService, LdapService ldapService) {
    ...
    public ModelAndView addPage() {
        ...
        addPage.addObject("roles", DevRole.values());
    ...
    private void prepareUserModelAndView(ModelAndView modelAndView) {
        ...
        modelAndView.addObject("roles", DevRole.values());
    }
}
